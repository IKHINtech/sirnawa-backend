...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/auth/send-forgot-password-verification": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Forgot Password Code Vefification",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/fcm/register": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Token registration data",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.RegisterTokenRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/utils.ResponseHandler"
                        }
                    },
                    "400": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.RemoveTokenRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid request body or token not found",
                        "schema": {
                            "$ref": "#/definitions/utils.ErrorResponse"
                        }
                    },
        ...
        "/house": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter Not In Group Ronda",
                        "name": "not_in_group_ronda",
                        "in": "query"
                    },
                    {
                        "enum": [
        ...
        "/housing-area": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create HousingArea",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.HousingAreaCreateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/housing-area/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Update HousingArea",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.HousingAreaUpdateRequset"
                        }
                    },
                    {
                        "type": "string",
        ...
        "/ipl-bill": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create IplBill",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.IplBillCreateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/ipl-bill-detail": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create IplBillDetail",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.IplBillDetailCreateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/ipl-bill-detail/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Ipl Bill Detail id",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Update IplBillDetail",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.IplBillDetailUpdateRequset"
                        }
                    },
                    {
                        "type": "string",
                        "description": "IplBillDetail id",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.IplBillGenerator"
                        }
                    }
                ],
                "responses": {
        ...
        "/ipl-bill/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Update IplBill",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.IplBillUpdateRequset"
                        }
                    },
                    {
                        "type": "string",
        ...
        "/ipl-rate": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create IplRate",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.IplRateCreateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/ipl-rate-detail": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create IplRateDetail",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.IplRateDetailCreateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/ipl-rate-detail/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Update IplRateDetail",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.IplRateDetailUpdateRequset"
                        }
                    },
                    {
                        "type": "string",
        ...
        "/ipl-rate/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Update IplRate",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.IplRateUpdateRequset"
                        }
                    },
                    {
                        "type": "string",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.ItemUpdateRequset"
                        }
                    },
                    {
                        "type": "string",
        ...
        "/resident": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Search Resident By Name",
                        "name": "search",
                        "in": "query"
                    }
                ],
    ...
    "definitions": {
        ...
        "models.House": {
            ...
            "properties": {
                ...
                "housing_area": {
                    "$ref": "#/definitions/models.HousingArea"
                },
                "housing_area_id": {
                    "type": "string"
                },
                ...
                "residentHouses": {
                    "$ref": "#/definitions/models.ResidentHouses"
                },
                "rt": {
                    "$ref": "#/definitions/models.Rt"
                },
                ...
                "rw": {
                    "$ref": "#/definitions/models.Rw"
                },
                "rw_id": {
                    "type": "string"
                },
                "status": {
                    "description": "aktif / tidak aktif / kontrak",
                    "allOf": [
                        {
                            "$ref": "#/definitions/models.HouseStatus"
                        }
                    ]
                },
                "updatedAt": {
        ...
        "models.Notification": {
            ...
            "properties": {
                ...
                "category": {
                    "description": "\"payment\", \"announcement\", \"event\", etc.",
                    "type": "string"
                },
                "createdAt": {
                    "type": "string"
                ...
                "data": {
                    "description": "Payload tambahan (JSON)",
                    "allOf": [
                        {
                ...
                "user": {
                    "description": "Relasi (optional, jika butuh eager loading)",
                    "allOf": [
                        {
                ...
                "user_id": {
                    "description": "Wajib, karena notifikasi harus punya target user",
                    "type": "string"
                }
            }
        },
        "models.Resident": {
            ...
            "properties": {
                ...
                "residentHouses": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.ResidentHouse"
                    }
                },
                "updatedAt": {
                    "type": "string"
        ...
        "request.HousingAreaCreateRequest": {
            "type": "object",
            "properties": {
                "latitude": {
                    "type": "number"
        ...
        "request.HousingAreaUpdateRequset": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "string"
        ...
        "request.IplBillDetailCreateRequest": {
            "type": "object",
            "properties": {
                "ipl_bill_id": {
                    "type": "string"
        ...
        "request.IplBillDetailUpdateRequset": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "string"
        ...
        "request.IplRateDetailCreateRequest": {
            "type": "object",
            "properties": {
                "amount": {
                    "type": "integer"
        ...
        "request.IplRateDetailUpdateRequset": {
            "type": "object",
            "properties": {
                "amount": {
                    "type": "integer"
